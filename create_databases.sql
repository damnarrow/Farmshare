...
VALUES 
  ('christine@gmail.com', 'Christine', 'Savadel'),
  ('steven@gmail.com', 'Steven', 'Damaro'), 
...
INSERT INTO UserPass VALUES ('root', 'password'),
                            ('user1', 'password'),
                            ('user2', 'password');
...
INSERT INTO UserRole VALUES ('root', 'service'),
                            ('user1', 'programmer'),
                            ('user2', 'programmer');
...
CREATE USER murach_user@localhost IDENTIFIED BY 'password';
...
INSERT INTO Product VALUES 
  ('1', '8601', 'Eggs - One dozen', '7.00'),
  ('2', 'pf01', 'Honey - 32 oz jar', '5.00'),
  ('3', 'pf02', 'Pickles - 32 oz jar', '5.50'),
  ('4', 'jr01', 'Plums - 1 lb.', '6.95');
